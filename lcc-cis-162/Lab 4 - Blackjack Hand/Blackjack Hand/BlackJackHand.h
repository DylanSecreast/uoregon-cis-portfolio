...
public:
	...
	~BlackJackHand(){ clearHand(); }					// Destructor. Deletes cards in hand.
	...
	void clearHand();				// This function clears the hand. Any cards in the hand are deleted. Deleted means that the delete operator is used on every card in the hand.
